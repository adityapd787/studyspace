    ...
    <>
      {DEMO_MODE && (
        <div id="setup-banner">
          ...
          <a style={{color:'var(--red)',fontWeight:600,cursor:'pointer'}} onClick={() => toast('1. Create project at supabase.com  2. Replace keys in src/lib/supabase.js','success')}>How to connect →</a>
        </div>
      )}
      <Nav />
